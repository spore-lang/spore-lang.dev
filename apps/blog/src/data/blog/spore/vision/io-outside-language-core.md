...
author: "六个骨头"
description: "Spore Vision 系列第 3 篇写作大纲：解释 effect system 与 Platform 为什么是语言世界观的一部分，而不是实现层技巧。"
...
- 说明 effect system 与 Platform 的价值，不是“更安全一点”，而是重新定义边界。
...
- `spore-evolution/seps/SEP-0003-effect-system.md`
  - `### Problems addressed`
  - `### Design goals`
