...
- The public homepage will live at `spore-lang.dev`.
- The language implementation currently lives in `spore-lang/spore`.
- Proposals, roadmap work, and process documents currently live in `spore-lang/spore-evolution`.
