/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config apps/docs/wrangler.jsonc apps/docs/worker-configuration.d.ts` (hash: 78c81aadca1122286f44e0b489c3935a)
